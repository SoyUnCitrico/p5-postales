class Teclado {
    ...
    async selectKey(codeKey = '', keyP = '', postalNumber = 1) {          
        if (this.debug) {
            ...
            // let array = JSON.stringify(this.textArray)
            // console.log(array)
            // console.log(array.length)
            // let comarray = JSON.stringify(this.textOriginalArray + '\n')
            // console.log(comarray)
            // console.log(comarray.length)
        }
        ...
        switch(codeKey) {    
            ...
            case 13: //enter
                ...
                if(
                    ...
                    try {
                        await this.sendData(this.fetchUrl, postalNumber, this.textArray);                        
                    }               
                    catch(error) {
                        console.error(error);
                    }
    ...
    async sendData (urlString = null, number = 12345, datos = null) {
        this.loadingResponse = true;
        if(urlString !== null && datos !== null) {
