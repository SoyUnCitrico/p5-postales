class PixelAtom {
    constructor(
        ...
        this.staticPosition = this.position.copy();
    ...
    arrivarOriginLetter(target = createVector(this.originalPosition.x, this.originalPosition.y), targetRadius = 80,typeBoundaries = 'OTHERSIDE') {
      this.arrive(target, targetRadius);
        this.actualizar();
        this.checkLimits(typeBoundaries);
        if (this.isLive)  {
